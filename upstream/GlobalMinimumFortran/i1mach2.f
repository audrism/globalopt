...
C     PORT FOR VAX COMPUTER
      INTEGER*4 IMACH(16)
      DATA IMACH/5,6,7,6,32,4,
     *2,31,2147483647,2,24,-127,127,56,-127,127/
...
c     EQUIVALENCE(RMACH(1),IEQ(1))
      DATA rmach/0.29e-38,0.17e+39,
     *0.596e-07,0.119e-06,0.301e+00/
...
c     EQUIVALENCE (DMACH(1),IEQ(1))
      DATA dmach/0.2938d-38,0.1701d+39,0.139d-16,0.278d-16,3.01d-01/
      IF (I.LT.1.OR.I.GT.5) GO TO 1
      D1MACH=DMACH(I)
      RETURN
    1 NERR =I1MACH(4)
