...
C     CALCULATES EXPECTED VALUE AND CONDITIONAL UNCERTAINTY
     ...
     C/BL6/A1,A2(5,20)/BL7/NK,AM(20)/BL8/A,NB,D/BL10/AB(10),NL(10),
...
C     ESTIMATION OF SCALE FACTORS
      COMMON /BL1/ZI,ZA,KT/BS1/Y(1000)/BL7/NA,AM(20)
     C/BL8/A1,NB,D/BL11/AMS(20)/STATIS/IFAIL,IT,ITM,L
...
C     MINIMIZATION OF MULTIMODAL FUNCTION FI(X,N)
     ...
     1/BL5/NH(5),LS(500)/BL7/NA,AM(20)/BL10/AB(10),NL(10),NX(10,100),AF
     2/BL12/KAU,FS(20),XS(20,20)/BL6/AUN1,AUN2(5,20)/GR1/DEL(20)
...
C     ESTIMATION OF K-TH MAXIMAL FUNCTION VALUE ZA
   ...
   90 CONTINUE
      F=ABS(ZI-ZA)
      IF (F.GT.1.E-8.AND.F.LT.SQRT(R1MACH(2))) GO TO 95
      IFAUL=10
      FM=ZI
      IT=L
      CALL INWR18(A,B,N,NM,IPAR,IPA)
...
C     MAIN LOOP OF GLOBAL MINIMIZATION
  ...
  140 CONTINUE
      ZM=-1.
      KT=1
      S1=S2*EXP(-ALOG(FLOAT(L))/FLOAT(N))
...
C     ESTIMATION OF LOCAL MINIMUM OF FU(X,N)
  ...
  740 FORMAT (/2X,57H**E R R O R  I N  U N T** VARIATION OF OBJECTIVE FU
     CNCTION/2X,25HIS TOO SMALL OR TOO LARGE)
      ...
      DIMENSION X(N)
      COMMON /INW/IN/BL12/KAU,FS(20),XS(20,20)
