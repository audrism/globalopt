...
C Modified from I1MACH.FOR. 1993, Audris Mockus.

      INTEGER FUNCTION I1MACH(I)
C     PORT FOR HP COMPUTER (Apollo workstations 715,735 based on float.h)
      INTEGER*4 IMACH(16)
...
c     EQUIVALENCE(RMACH(1),IEQ(1))
      DATA rmach/1.1754943508222875e-38,3.4028234663852886e+38,
...
c     EQUIVALENCE (DMACH(1),IEQ(1))
     ...
     C1.1102230246251565d-16,2.2204460492503131d-16,
     C3.010299956639812e-01/
      IF (I.LT.1.OR.I.GT.5) GO TO 1
      D1MACH=DMACH(I)
      RETURN
    1 NERR =I1MACH(4)
